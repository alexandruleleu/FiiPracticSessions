...
//listener for enter keypres which launch a specific method (sign in / sign out)
...
export default class Login extends Component {
    ...
    //animation logic between signUp and signIn screen
    // transition component from semanti-ui-react
    onClickSignUp = () => {
        this.setState({
